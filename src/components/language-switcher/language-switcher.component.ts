...
@Component({
  ...
  template: `
    <div class="relative inline-block text-start">
      ...
      @if (isOpen()) {
        <div class="origin-top-end absolute end-0 mt-2 w-56 rounded-md shadow-lg bg-gray-700 ring-1 ring-black ring-opacity-5 focus:outline-none z-50 max-h-60 overflow-y-auto" role="menu" aria-orientation="vertical">
